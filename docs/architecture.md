...
`RU_ADDRESS` intentionally limited: это regex recognizer для небольшого корпуса распространённых форм (`ул. Ленина, д. 10`, `ул Ленина 10`, `г. Москва, ул. Тверская`, `Тверская улица, дом 7`). Unsupported/ограниченные случаи: полный парсинг индексов, регионов, владений, корпусов без улицы, `Тверская улица 7` без `дом/д.`, multi-word street names без `дом/д.`, свободные адреса без street/house structure и неоднозначные фразы со словами `улица`, `дом`, `адрес` без фактического адреса.
