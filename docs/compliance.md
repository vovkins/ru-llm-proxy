...
Для состава с `codex-lb` выполняйте тот же контур с
...
В составе с `codex-lb` пароль его администратора, OAuth-сессии и
...
- в составе с `codex-lb` LiteLLM обращается к нему по внутренней сети, а внешний
