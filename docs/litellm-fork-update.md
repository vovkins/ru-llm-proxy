...
| Версия образа | `ghcr.io/vovkins/litellm:1.97.0-multi-oauth.9` |
| Ссылка для развёртывания | `ghcr.io/vovkins/litellm@sha256:3eed7aa87c3c18b7b3ad0c3a1b71a4bb6086e6a332417a5e495bad79d62342ac` |
...
20 августа 2026 года исходной точкой ответвления оставался выпуск `v1.97.0`, а
BerriAI/litellm#33680 оставался открытым. В выпуске
`1.97.0-multi-oauth.9` прошли 488 тестов OAuth, маршрутизации, Responses API,
Redis, эмулятора и метрик, а также 191 тест Router. Контейнерные образы
`linux/amd64` и `linux/arm64` прошли отдельные быстрые проверки и объединены в
один манифест. Для образа опубликованы перечень компонентов (SBOM), сведения о
происхождении и аттестация сборки.
...
- [успешная публикация образа](https://github.com/vovkins/litellm/actions/runs/32412181115).
