...
| Версия образа | `ghcr.io/vovkins/litellm:1.97.0-multi-oauth.8` |
| Ссылка для развёртывания | `ghcr.io/vovkins/litellm@sha256:6710a3968450117678e816fcf3705555c0fccef2bd0adc4d6e39af6ebb44cbe7` |
...
`1.97.0-multi-oauth.8` прошли 619 объединённых тестов OAuth, маршрутизации,
...
- [успешная публикация образа](https://github.com/vovkins/litellm/actions/runs/32296815257).
