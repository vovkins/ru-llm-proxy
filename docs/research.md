...
2. **Сложнее развёртывание:** pip, virtualenv, зависимости, управление Python-процессом
...
## Варианты развёртывания варианта А
...
5. **Redis** — обязательное временное хранилище обратимых сопоставлений PII и закрепления развёртываний LiteLLM
...
**Docker Compose** — лучший вариант для MVP и промышленной среды:
...
5. Для нескольких развёртываний одной группы моделей включено закрепление маршрута LiteLLM через `deployment_affinity`.
