...
Перед применением прочитайте основное руководство: [docs/egress-controls.md](../../../docs/egress-controls.md).

## Файлы

| Файл | Назначение |
| --- | --- |
| `default-deny-egress.yaml` | Запрет исходящих соединений по умолчанию на уровне namespace для всех подов. |
...
- Замените namespace `ru-llm-proxy`, если в кластере используется другое пространство имён.
- Согласуйте метки `app.kubernetes.io/name` с чартом Helm или манифестами вашей установки.
...
Полный промышленный проект Kubernetes отслеживается отдельно в задаче #59.
