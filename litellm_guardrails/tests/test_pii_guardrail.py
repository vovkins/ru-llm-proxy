...
def dependency_client_cache_isolation():
    if hasattr(pii_guardrail, "_clear_dependency_client_caches_for_tests"):
        pii_guardrail._clear_dependency_client_caches_for_tests()
    yield
    if hasattr(pii_guardrail, "_clear_dependency_client_caches_for_tests"):
        pii_guardrail._clear_dependency_client_caches_for_tests()
