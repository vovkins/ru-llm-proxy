...
| RAM | 2 GB | 4 GB+ |
| Диск | 10 GB | 20 GB+ |
| Provider key | `ZAI_API_KEY` | `ZAI_API_KEY`; опционально `ZAI_API_KEY_2` как секрет для второго deployment |
...
#   ZAI_API_KEY_2=optional-second-account  # сам по себе не включает второй deployment
