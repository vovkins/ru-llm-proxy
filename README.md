...
- Две подписки Z.AI Coding Plan в одном пуле (`ZAI_API_KEY`, `ZAI_API_KEY_2`) и закрепление клиентского ключа за выбранным провайдером модели.
...
LiteLLM Proxy :4000
  ...
  │
  ├─ маршрутизация LiteLLM: провайдеры моделей для glm-5.2 / glm-5.1
  │
...
| `make routing-smoke` | Проверить закрепление провайдера модели за одним ключом. |
