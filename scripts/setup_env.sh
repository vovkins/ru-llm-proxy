...
ensure_key_exists "PRESIDIO_ANALYZER_INTERNAL_DOMAIN_SUFFIXES" "internal,local,lan,corp,corp.local,cluster.local,svc.cluster.local"
ensure_key_exists "PRESIDIO_ANALYZER_DETECT_PUBLIC_IPS" "false"
ensure_key_exists "PII_GUARDRAIL_MODE" "mask"
ensure_key_exists "DICTIONARY_SUBSTITUTIONS_ENABLED" "true"
ensure_key_exists "DICTIONARY_SUBSTITUTIONS_FILE" "/app/litellm_guardrails/dictionary-substitutions.default.json"
ensure_key_exists "DICTIONARY_SUBSTITUTIONS_JSON" ""
ensure_key_exists "DICTIONARY_SUBSTITUTIONS_FAILURE_MODE" "fail_closed"
ensure_key_exists "SYNTHETIC_PII_ALLOWLIST_MODE" "off"
ensure_key_exists "SYNTHETIC_PII_ALLOWLIST_JSON" "[]"
ensure_key_exists "REGULATED_TOPIC_POLICY_MODE" "off"
